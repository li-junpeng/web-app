  ...
  routes: [
    ...
    },
    {
      ...
      meta: {
        ...
        thumb: `${import.meta.env.BASE_URL}/assets/images/component-thumb/streamer-card.png`
      },
    ...
    },
    {
      ...
      meta: {
        title: '边框跟随鼠标高亮',
        thumb: `${import.meta.env.BASE_URL}/assets/images/component-thumb/mouse-hover-border.png`
      },
    ...
    {
      path: '/loading-group-03',
      name: 'LoadingGroup03',
      meta: {
        title: 'loading - group - 03'
      },
      component: () => import('@/views/components/loading-group-03/index.vue')
    },
    {
      path: '/loading-group-04',
      name: 'LoadingGroup04',
      meta: {
        title: 'loading - group - 04'
      },
      component: () => import('@/views/components/loading-group-04/index.vue')
    },
    {
      path: '/loading-01',
      name: 'Loading01',
    ...
    },
    {
      ...
      component: () => import('@/views/components/loading-28/index.vue')
    },
    {
      path: '/loading-29',
      name: 'Loading29',
      ...
      component: () => import('@/views/components/loading-29/index.vue')
    },
    {
      path: '/loading-30',
      name: 'Loading30',
      ...
      component: () => import('@/views/components/loading-30/index.vue')
    },
    {
      path: '/loading-31',
      name: 'Loading31',
      ...
      component: () => import('@/views/components/loading-31/index.vue')
    },
    {
      path: '/loading-32',
      name: 'Loading32',
      ...
      component: () => import('@/views/components/loading-32/index.vue')
    },
    {
      path: '/loading-33',
      name: 'Loading33',
      ...
      component: () => import('@/views/components/loading-33/index.vue')
    },
    {
      path: '/loading-34',
      name: 'Loading34',
